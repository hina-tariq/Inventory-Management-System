...
class salesClass:
    def __init__(self,root):
        ...
        #============title===================
        lbl_title = Label(self.root,text="View Customer Bills",font=("goudy old style",30),bg="Sea Green",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        lbl_title = Label(bill_Frame,text="Customer Bill Area",font=("goudy old style",20),bg="Orange",fg="white").pack(side=TOP,fill=X)
