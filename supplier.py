...
class supplierClass:
    def __init__(self,root):
        ...
        #====================SearchFrame===============
        #====================options====================
        lbl_search = Label(self.root,text="Invoice No.",bg="white",font=("gougy old style",15))
        ...
        btn_search = Button(self.root,text="Search",command=self.search,font=("goudy old style",15),bg="dark green",fg="white",cursor="hand2").place(x=980,y=79,width=100,height=28)

        #==============title=========================
        title = Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="navy blue",fg="white").place(x=50,y=10,width=1000,height=40)
        ...
        btn_delete = Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="orange",fg="white",cursor="hand2").place(x=420,y=370,width=110,height=35)
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row = cur.fetchone()
            if row != None:
                messagebox.show("Error","Invoice No. already assigned.Try different one",parent=self.root)
            else:
    ...
    def update(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row = cur.fetchone()
            if row == None:
                messagebox.show("Error","Invalid Invoice No.",parent=self.root)
            else:
