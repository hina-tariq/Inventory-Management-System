...
class categoryClass:
    def __init__(self,root):
        ...
        #============title===================
        lbl_title = Label(self.root,text="Manage Product Category",font=("goudy old style",30),bg="Sea Green",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
                ...
                row = cur.fetchone()
            if row != None:
                messagebox.show("Error","This Category is already present.Try different one",parent=self.root)
            else:
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get()=="":
                ...
                row = cur.fetchone()
            if row == None:
                messagebox.show("Error","Error: Please try again.",parent=self.root)
            else:
