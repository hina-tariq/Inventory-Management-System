...
class employeeClass:
    def __init__(self,root):
        ...
        #====================options====================
        cmb_search = ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","Email","Name","Contact"),state='readonly',justify=CENTER,font=("gougy old style",15))
        ...
        #==============title=========================
        title = Label(self.root,text="Employee Details",font=("goudy old style",15),bg="navy blue",fg="white").place(x=50,y=100,width=1000)
        ...
        cmb_gender = ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Other"),state='readonly',justify=CENTER,font=("gougy old style",15))
        ...
        cmb_utype = ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admin","Employee"),state='readonly',justify=CENTER,font=("gougy old style",15))
        ...
        btn_delete = Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="orange",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=28)
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row = cur.fetchone()
            if row != None:
                messagebox.show("Error","This Employee ID is already assigned.Try different one",parent=self.root)
            else:
    ...
    def update(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row = cur.fetchone()
            if row == None:
                messagebox.show("Error","Invalid Employee ID",parent=self.root)
            else:
